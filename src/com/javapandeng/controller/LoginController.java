...
//http://localhost:8080/test1_war_exploded/login/uIndex
//http://localhost:8080/test1_war_exploded/login/login
@Controller
...
//       request创建session 保存信息，要记得在退出时清理session，否则会出现页面切换时没有登入用户也能进入后台的情况。
